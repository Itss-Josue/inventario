...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title text-center">Nuevo Cliente</h4>
                <br>
                <form class="form-horizontal" id="frmRegistrarCliente">
                    ...
                    <div class="form-group row mb-2">
                        <label for="contacto" class="col-3 col-form-label">Persona de Contacto</label>
                        <div class="col-9">
                    ...
                    <div class="form-group mb-0 justify-content-end row text-center">
                        <div class="col-12">
                            <a href="<?php echo BASE_URL;?>clientes" class="btn btn-light waves-effect waves-light">Regresar</a>

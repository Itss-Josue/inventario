...
class vistaModelo
{
    protected static function obtener_vista($vista)
    {
        ...
        $palabras_permitidas_n1 = ['inicio', 'usuarios', 'nuevo-usuario', 'instituciones', 'nueva-institucion', 'ambientes', 'nuevo-ambiente', 'bienes',  'nuevo-bien', 'movimientos', 'nuevo-movimiento','imprimir-movimiento','reporte-bienes','imprimir-pdfs','clientes','nuevo-cliente','proyectos','nuevo-proyecto','nuevo-token-api','tokens-api','clientes-api','nuevo-cliente-api'];
